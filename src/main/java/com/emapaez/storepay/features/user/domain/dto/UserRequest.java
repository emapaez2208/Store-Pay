...
public record UserRequest(@Schema(description = "The user's name, max length: 50.", example = "John", maxLength = 50, required = true)
                          ...
                          String lastName,
                          @Schema(description = "Argentinian DNI. Accepted formats: 12345678 or 12.345.678.", example = "12.456.789", required = true)
                          @ValidDni(message = "The DNI must be valid, with between 7 and 8 digits.")
                          String dni,
                          @Schema(description = "The user's Email.", example = "johndoe@email.com", required = true)
                          ...
                          Long phoneNumber,
                          @Schema(description = "The externalId of Store where the user works.", example = "123e4567-e89b-12d3-a456-426614174000", required = true)
