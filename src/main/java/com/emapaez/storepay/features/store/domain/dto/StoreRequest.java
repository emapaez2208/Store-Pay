...
public record StoreRequest(
        ...
        @Schema(description = "The store name, max length: 30", example = "Tech Store", maxLength = 30, required = true)
        @NotBlank(message = "The name cannot be null or blank.")
        @Size(max = 30, message = "The name must be a maximum of 30 characters.")
        String name,
        @Schema(description = "Argentinian CUIT/CUIL. Accepted formats: 20384971777 or 20-38497177-7", example = "20-38497177-7", maxLength = 13, required = true)
