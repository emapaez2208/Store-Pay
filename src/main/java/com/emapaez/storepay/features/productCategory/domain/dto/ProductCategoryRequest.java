...
public record ProductCategoryRequest (@Schema(description = "The product category name, max length: 30", example = "Drinks", maxLength = 30, requiredMode = Schema.RequiredMode.REQUIRED)
