...
public record CartItemUpdatePrice(@Schema(description = "The product price. It can contain a maximum of 8 digits before the decimal point and 2 digits after it", example = "110.99", requiredMode = Schema.RequiredMode.REQUIRED)
